...
%%
% sigramp=-dedt*(a*ae*be*(exp(-b*t)/(b + be*dedt) - exp(be*dedt*t)/(b + be*dedt))...
%     + ae*be*c*(exp(-d*t)/(d + be*dedt) - exp(be*dedt*t)/(d + be*dedt))...
%     + ae*be*g*(exp(-h*t)/(h + be*dedt) - exp(be*dedt*t)/(h + be*dedt)))
